...
namespace WorkloadTracker.API.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChangeRequests_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskAcknowledgements_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskAcknowledgements_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChangeRequests_TaskId",
                table: "ChangeRequests",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAcknowledgements_TaskId",
                table: "TaskAcknowledgements",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskAcknowledgements_UserId",
                table: "TaskAcknowledgements",
                column: "UserId");
